...
Hoặc có thể set lại data lưu vào database
...
- ví dụ set lại mã hóa password
    ...
    ```
- Nếu mà `Muốn set Entity` cho một table nào đó Ví dụ `CoursesTable` phải đặt là `Course`, vì Entity đại diện cho 1 bản ghi. Hoặc có thể  set lại Entity
    ...
    class UsersTable extends Table
    {
        ...
        {
            $this->setTable('users');
            $this->setEntityClass( Users::class); // set Entity
        }
    }
    ```